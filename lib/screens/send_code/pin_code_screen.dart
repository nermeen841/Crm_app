...
class PinCodeVerificationScreen extends StatefulWidget {
  ...
  const PinCodeVerificationScreen({Key? key,required this.phoneNumber, required this.verificationId,}) : super(key: key);
...
class _PinCodeVerificationScreenState extends State<PinCodeVerificationScreen> {
  ...
  //
  //   ConfirmationResult confirmationResult = await _auth.signInWithPhoneNumber('+2${widget.phoneNumber}');
  //   // PhoneAuthCredential credential = PhoneAuthProvider.credential(verificationId: '', smsCode: '');
  //   await _auth.signInWithCredential(credential).then((user) async {
  //     final theFinalToken =  user.credential!.token;
  //
  //     print('______this user FB data is: $theFinalToken');
  //   });
  // }
