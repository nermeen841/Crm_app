...
class PinCodeResetPasswordVerificationScreen extends StatefulWidget {
  final String? phoneNumber;
  final String verificationId;


  const PinCodeResetPasswordVerificationScreen({Key? key,required this.phoneNumber, required this.verificationId,}) : super(key: key);

  @override
  _PinCodeResetPasswordVerificationScreenState createState() =>
      _PinCodeResetPasswordVerificationScreenState();
}

class _PinCodeResetPasswordVerificationScreenState extends State<PinCodeResetPasswordVerificationScreen> {
  ...
  void signInWithPhoneNumber() async {
    ...
    try {
      final AuthCredential credential = PhoneAuthProvider.credential(
        verificationId: ForgetPasswordBody.ID,
