            ...
            InkWell(
              onTap: (){
                Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => WebDesignOptionInsideServicesScreen(),
                    ));
              },
             child: buildCardServicesScreen(subText: '10 خدمات فرعية', text: "تصميم مواقع"),
            ),
            myDivider(1),
            buildCardServicesScreen(subText: '10 خدمات فرعية', text: "برامج حسابات"),
            myDivider(1),
          ],
        ),
      ),
